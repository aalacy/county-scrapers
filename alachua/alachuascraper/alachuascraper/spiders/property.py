...
class PropertySpider(scrapy.Spider):
	...
	meta = {
		"proxy": "http://scraperapi:92975321be6c2765177bcc543bd86790@proxy-server.scraperapi.com:8001"
	}
	...
	def dump_page(self, response):
		filename = f'dump.html'
