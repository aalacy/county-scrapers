...
class Spider(threading.Thread):
    ...
    def _create_new_session(self):
        self.session = requests.Session()
        self.session.proxies = {'http': 'http://127.0.0.1:8120', 'https': 'http://127.0.0.1:8120'}
    ...
    def _start(self, r):
        #40560488
        url = f'https://or.duvalclerk.com/Image/DocumentPdfAllPages/{r}'
        ua = get_random_ua()
        headers = {
            'User-Agent': ua,
        }
    ...
    def upload_dump_to_s3(self, tmp_name, name):
        year = name.split('-')[0]
        bucketkey = 'duval/{}/{}'.format(year, name)
    ...
    def parse_html(self, r):
        url = f'https://or.duvalclerk.com/details/documentdetails/{r}'
...
# doc = "https://or.duvalclerk.com/details/documentdetails/16625137"
# pdf = "https://or.duvalclerk.com/Image/DocumentPdfAllPages/16625137"
